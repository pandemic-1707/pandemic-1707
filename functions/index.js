...
// KM/SH: could be a single object
// KM/SH: keep city data in one place
const cities = require('./data/cities')
const infectionDeck = require('./data/infectionDeck')
const events = require('./data/events')
const {deckUtils, playerDeckUtils, playerUtils} = require('pandemic-1707-utils')
...
// initializes player locations at the same time
exports.initializePlayerInfo = functions.database.ref('/rooms/{name}')
  .onCreate(event => {
    ...
    const {playerDeck, playerHands} = playerDeckHands
